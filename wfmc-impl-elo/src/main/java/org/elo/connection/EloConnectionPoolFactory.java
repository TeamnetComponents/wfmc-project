...
public class EloConnectionPoolFactory extends BaseKeyedPoolableObjectFactory<EloConnectionDetails, IXConnection> {
    ...
    public EloConnectionPoolFactory(EloConnectionManager eloConnectionManager) {
        this.eloConnectionManager = eloConnectionManager;
    }

    public EloConnectionManager getEloConnectionManager() {
        return eloConnectionManager;
    }

    public int getPoolCount() {
        return Integer.parseInt(this.eloConnectionManager.getServiceProperties().getProperty(POOL_COUNT, "0"));
    }
