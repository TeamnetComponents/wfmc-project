...
public abstract class AbstractAuditingAspect {
    ...
    /**
     * A pointcut for specifying methods bearing the {@link Auditable} annotation.
     */
    ...
    /**
     * Retrieves the proper MethodAuditingStrategyFactory implementation based on the {@link Auditable#strategy} value
    ...
    /**
     * Perform auditing for all methods with the {@link Auditable} annotation.
     *
