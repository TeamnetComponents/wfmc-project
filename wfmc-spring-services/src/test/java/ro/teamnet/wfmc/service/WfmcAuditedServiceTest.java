...
public class WfmcAuditedServiceTest {
    ...
    public void prepareTestsForAuditing() throws WMWorkflowException {
        ...
        processInstanceId = wfmcService.createProcessInstance(PROC_DEF_ID, WfmcAuditedParameter.PROCESS_INSTANCE_NAME );
        Assert.assertEquals("Not equal processInstanceId for createProcessInstance", WfmcServiceMockImpl.PROCESS_INSTANCE_ID, processInstanceId);
    }
    ...
    public void testCreateProcessInstance() throws WMWorkflowException {
        ...
        Assert.assertEquals("The process instance name isn't the same!", wmProcessInstanceAudit.getProcessDefinitionBusinessName(), WfmcAuditedParameter.PROCESS_INSTANCE_NAME);
    ...
    public void testAssignProcessInstanceAttribute() throws WMWorkflowException {
        ...
        WMProcessInstanceAudit wmProcessInstanceAudit = wfmcAuditQueryService.
                findWMProcessInstanceAuditByProcessDefinitionBusinessName(WfmcAuditedParameter.PROCESS_INSTANCE_NAME);
        ...
        Assert.assertEquals("The attribute name isn't the same!", wmEventAuditAttribute.getWmAttributeAudit().
                getAttributeName(), "attr1");
        log.info("Attribute audit name: {}", wmEventAuditAttribute.getWmAttributeAudit().getAttributeName());
        WMAttributeAuditProcessInstance wmAttributeAuditProcessInstance = wfmcAuditQueryService.
                findWMAttributeAuditProcessInstanceByWMProcessInstanceAudit(wmProcessInstanceAudit);
        ...
        log.info("Process instance id: {}", wmAttributeAuditProcessInstance.getWmProcessInstanceAudit().
                getProcessInstanceId());
        Assert.assertEquals("The process definition id isn't the same!", wmAttributeAuditProcessInstance.
                        getWmProcessInstanceAudit().getProcessDefinitionId(),
                wmProcessInstanceAudit.getProcessDefinitionId());
        log.info("Process definiton id: {}", wmAttributeAuditProcessInstance.getWmProcessInstanceAudit().
                getProcessDefinitionId());
        Assert.assertEquals("The process definition business name isn't the same!", wmAttributeAuditProcessInstance.
                        getWmProcessInstanceAudit().getProcessDefinitionBusinessName(),
                wmProcessInstanceAudit.getProcessDefinitionBusinessName());
        log.info("Process definition business name: {}", wmAttributeAuditProcessInstance.getWmProcessInstanceAudit().
    ...
    public void testStartProcess() throws WMWorkflowException {
        ...
        Assert.assertEquals("Not equal processInstanceId for startProcessInstance",WfmcServiceMockImpl.NEW_PROCESS_INSTANCE_ID, newProcessInstanceId);

        WMProcessInstanceAudit wmProcessInstanceAudit = wfmcAuditQueryService.findWMProcessInstanceAuditByProcessDefinitionBusinessName(WfmcAuditedParameter.PROCESS_INSTANCE_NAME);
        WMEventAudit wmEventAudit = wfmcAuditQueryService.findByEventCode(WMAEventCode.STARTED_PROCESS_INSTANCE_INT);
        log.info("Process definition id: {}", wmProcessInstanceAudit.getProcessDefinitionId());
        Assert.assertEquals("Not equal processDefinitionId for startProcess", PROC_DEF_ID,wmProcessInstanceAudit.getProcessDefinitionId());
        log.info("Process instance name: {}", wmProcessInstanceAudit.getProcessDefinitionBusinessName());
        Assert.assertEquals("Not equal processDefinitionBusinessName for startProcess", WfmcAuditedParameter.PROCESS_INSTANCE_NAME,wmProcessInstanceAudit.getProcessDefinitionBusinessName());
        log.info("Process instance id: {}", wmProcessInstanceAudit.getProcessInstanceId());
        log.info("Username: {}", wmEventAudit.getUsername());
    ...
    public void testAssignWorkItemAttribute() throws WMWorkflowException {
        ...
        Assert.assertEquals("The workItemId isn't the same!", wmWorkItemAudit.getWorkItemId(), WORK_ITEM_ID);
